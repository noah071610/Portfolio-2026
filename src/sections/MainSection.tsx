    ...
    <div className={cn("w-full h-full overflow-scroll")}>
      ...
      >
        ...
        >
          ...
          {playNumber !== 1 && playNumber !== 3 && playNumber !== 4 && playNumber !== 5 && playNumber !== 7 && <Main />}
        </div>
              ...
              <ul className={cn("w-full flex flex-col gap-5 mb-2")}>
                <li className={cn("flex flex-col")}>
                  ...
                  <ul className={cn("flex flex-wrap gap-1")}>
                    ...
                    <img src={`https://img.shields.io/badge/${skillMap.flutter}`} alt="flutter" className={cn("h-5")} />
                    <img
                ...
                <li className={cn("flex flex-col")}>
                  ...
                  <ul className={cn("flex flex-wrap gap-1")}>
                    ...
                    <img src={`https://img.shields.io/badge/${skillMap.fastapi}`} alt="fastapi" className={cn("h-5")} />
                    <img
